#
#  Be sure to run `pod spec lint DynetixUtility.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/tchan1010/DynetixUtility.git", :tag => "1.0.2" }
  #spec.source       = { :path =>'.' }
  ...
  spec.source_files  = "DynetixUtility"
